            ...
            <div className="md:flex md:space-x-8">
                <section className="m-4 mb-8 md:mb-0 md:w-1/2 double-border" style={{ borderColor: 'var(--col-navbar)' }}>
                    ...
                    <div className="p-3 space-y-4 text-left text-text">
                        <p>¿Necesitas información o ayuda? En nuestras oficinas de atención ciudadana y servicios territoriales de la Generalitat, te brindamos información y asistencia sobre servicios y trámites relacionados con las sequías.</p>
                        ...
                        <ul className="pl-5 space-y-2 list-disc">
                            ...
                            <li>Asistencia Personalizada: Te acompañamos en los trámites en nuestras oficinas.</li>
                ...
                <form className="max-w-lg p-8 pt-20 mx-auto rounded-lg shadow-md bg-body md:w-1/2">
