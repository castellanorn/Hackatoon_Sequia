...
const Home = () => {
  return (
    ...
    <>
    <h2 className="text-white mt-20 mb-0 p-4 font-normal text-[xx-large]" >
      SEQUIATRON
    </h2>
    <div className="flex flex-row mt-4 mb-0 w-[100%] h-[50%]">
      <div className="w-2/4 h-2/4 p-4 text-[large]">
